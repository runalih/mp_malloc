...
test1: tests/test.o tests/lib/mstats-utils.so tests/test-week1-samples.cpp alloc.so tests/test-pp.cpp
	$(CXX) $(CFLAGS_CATCH) tests/test.o tests/lib/mstats-utils.so tests/test-week1-samples.cpp -o $@
